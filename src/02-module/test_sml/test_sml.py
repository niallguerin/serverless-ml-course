...
def test_time_delta():
    date_time1 = int((datetime(2020, 5, 25, 11, 35, 00).strftime("%Y%m%d%H%M%S")))
    date_time2 = int((datetime(2020, 5, 20, 15, 40, 00).strftime("%Y%m%d%H%M%S")))
    expected_time_delta = 4959500
